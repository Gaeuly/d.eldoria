...
import { Crown, Menu, X, Sparkles, Shield, MessageSquare, Star, Users, Home } from 'lucide-react';
...
const Navbar = () => {
  ...
  const handleNavClick = (path) => {
    setCurrentPath(path);
    setIsOpen(false);
    // Here you would typically use your router's navigation
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex items-center justify-between h-16">
            {/* Logo */}
            <div className="flex items-center space-x-3 group relative cursor-pointer" onClick={() => handleNavClick('/')}>
              <div className="relative">
                <Crown className="text-yellow-400 text-2xl group-hover:scale-110 transition-all duration-300 drop-shadow-lg" />
        ...
        <div className={`md:hidden transition-all duration-500 ease-in-out overflow-hidden ${
          ...
          <div className="bg-gradient-to-b from-black/95 via-gray-900/95 to-black/95 backdrop-blur-xl border-t border-yellow-400/20">
